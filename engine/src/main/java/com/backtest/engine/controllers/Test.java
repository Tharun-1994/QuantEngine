...
//			conditions.add(RuleCondition.builder().indicator(indicator).indicatorLookBack(indicatorLookBack)
//					.operator(operator).value(value).connectOperator(connectOp).build());
//
//		}
//
//		return conditions;
...
//		System.err.println(Test.parseEntryRules("rsi_14 < 10 && atr_100 < 54 && hv_100 < 54"));
//	}
//}

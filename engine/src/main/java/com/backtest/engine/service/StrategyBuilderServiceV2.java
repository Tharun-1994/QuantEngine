...
public interface StrategyBuilderServiceV2 {
	...
	Map<String, List<String>> signalsForTheDayV1(LocalDate date, PriceDataV2 priceData, BuySellDataV2 buySellData,
			PortfolioServiceV2 portfolioService);

	BuySellDataV2 generateSignalsV1(StrategyDataV2 strategyData, PriceDataV2 priceData);
}
